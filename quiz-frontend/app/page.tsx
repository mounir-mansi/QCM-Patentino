      ...
      <AnimatedBackground />
        ...
        <div className="relative z-10 my-2 min-content-height">        
          ...
          <Title title="Welcome to the Quizine" />
            ...
            <div className="w-full max-w-6xl mb-6 h-[calc(100vh-190px)] rounded-2xl overflow-hidden shadow-xl flex flex-col">
              ...
              <div className="flex-[2] bg-[#0d1b2a] text-[#f0c040] px-5 pt-6 pb-4 -mt-8 rounded-t-2xl relative z-10 flex flex-col justify-center">
                <h5 className="text-lg md:text-3xl font-extrabold tracking-wide text-center mb-2">
                  Bienvenue sur la web app de quiz ULTIME !
                </h5>
                <p className="text-white font-bold text-sm md:text-lg text-left md:text-center py-2">
