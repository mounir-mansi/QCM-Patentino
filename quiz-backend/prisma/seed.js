...
async function main() {
  ...
  const questionsData = [
...

    {
      ...
      answer: [
        { title_answer: "Trasportare persone", result_answer: false },
        { title_answer: "Sollevare e movimentare carichi", result_answer: true },
        { title_answer: "Spostare automobili", result_answer: false },
      ],
    },
    {
      ...
      answer: [
        { title_answer: "Chiunque abbia la patente B", result_answer: false },
        { title_answer: "Solo chi è formato e in possesso del patentino", result_answer: true },
        { title_answer: "Un minore con autorizzazione dei genitori", result_answer: false },
      ],
    },
    {
      question_title: "Prima di usare un carrello, cosa bisogna controllare?",
      ...
      module_id: module.id,
      answer: [
        { title_answer: "La pressione delle gomme, i freni e i comandi", result_answer: true },
        { title_answer: "Il colore della carrozzeria", result_answer: false },
        { title_answer: "Che ci sia il pieno di carburante anche se elettrico", result_answer: false },
      ],
    },
    {
      question_title: "Cosa indica la targhetta di portata del carrello?",
      ...
      answer: [
        { title_answer: "La velocità massima del mezzo", result_answer: false },
        { title_answer: "Il peso massimo sollevabile in sicurezza", result_answer: true },
        { title_answer: "Il livello di batteria", result_answer: false },
      ],
    },
    {
    ...
    },
    {
      ...
      answer: [
        { title_answer: "Alte al massimo", result_answer: false },
        { title_answer: "A circa 15-30 cm da terra", result_answer: true },
        { title_answer: "Appoggiate completamente a terra", result_answer: false },
      ],
    },
    {
      question_title: "Se un pedone attraversa davanti al carrello, cosa fare?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
    ...
    },
    {
      ...
      module_id: module.id,
      answer: [
        { title_answer: "Adeguata all’ambiente e alle condizioni di lavoro", result_answer: true },
        { title_answer: "Sempre al massimo consentito", result_answer: false },
        { title_answer: "Uguale a quella delle automobili", result_answer: false },
      ],
    },
    {
      ...
      answer: [
        { title_answer: "Saltare fuori subito", result_answer: false },
        { title_answer: "Restare seduto e tenersi saldamente", result_answer: true },
        { title_answer: "Alzare le forche per bilanciare", result_answer: false },
      ],
    },
    {
      question_title: "In salita, come si deve trasportare il carico?",
    ...
    },
    {
      ...
      module_id: module.id,
      answer: [
        { title_answer: "Mantenere fermo il carrello quando non è in uso", result_answer: true },
        { title_answer: "Aumentare la velocità", result_answer: false },
        { title_answer: "Bloccare le forche", result_answer: false },
      ],
    },
    {
      ...
      answer: [
        { title_answer: "Solo in pendenza", result_answer: false },
        { title_answer: "Ogni volta che il carrello è fermo", result_answer: true },
        { title_answer: "Mai", result_answer: false },
      ],
    },
    {
      ...
      module_id: module.id,
      answer: [
        { title_answer: "Impedire movimenti bruschi dell’operatore", result_answer: false },
        { title_answer: "Trattenere l’operatore in caso di ribaltamento", result_answer: true },
    ...
    },
    {
      ...
      answer: [
        { title_answer: "Solo per salutare i colleghi", result_answer: false },
        { title_answer: "Per segnalare la propria presenza", result_answer: true },
        { title_answer: "Mai, è vietato", result_answer: false },
      ],
    },
    {
      ...
      answer: [
        { title_answer: "In ambienti chiusi", result_answer: false },
        { title_answer: "All’aperto o in ambienti ben ventilati", result_answer: true },
        { title_answer: "In ufficio", result_answer: false },
      ],
    },
    {
      question_title: "È consentito parlare al telefono durante la guida del carrello?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
    ...
    {
      question_title: "Il libretto d’uso e manutenzione del carrello deve essere:",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Sempre disponibile sul posto di lavoro", result_answer: true },
        { title_answer: "Solo in ufficio", result_answer: false },
        { title_answer: "Non serve", result_answer: false },
      ],
    },
    {
      question_title: "Se un carico è instabile sul pallet, cosa fare?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
    ...
    },
    {
      ...
      module_id: module.id,
      answer: [
        { title_answer: "Velocemente per ridurre il tempo di trasporto", result_answer: false },
        { title_answer: "Con delicatezza e stabilizzato", result_answer: true },
        { title_answer: "Alzandolo il più possibile", result_answer: false },
      ],
    },
    ...
    },
    {
      ...
      module_id: module.id,
      answer: [
        { title_answer: "Freno a mano inserito, motore spento, forche abbassate", result_answer: true },
        { title_answer: "Motore acceso, forche alte", result_answer: false },
        { title_answer: "Solo accostato senza freno", result_answer: false },
      ],
    },
    {
      question_title: "È consentito trasportare persone sul carrello elevatore?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
    ...
    },
    {
      ...
      answer: [
        { title_answer: "Accelerare", result_answer: false },
        { title_answer: "Suonare il clacson e ridurre la velocità", result_answer: true },
        { title_answer: "Sollevare al massimo le forche", result_answer: false },
      ],
    },
    {
      question_title: "Perché non bisogna sollevare il carico troppo in alto durante il trasporto?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Perché può cadere o sbilanciare il mezzo", result_answer: true },
        { title_answer: "Perché il motore consuma di più", result_answer: false },
        { title_answer: "Perché rallenta la marcia", result_answer: false },
      ],
    },
    {
      question_title: "Cosa bisogna indossare obbligatoriamente durante l’uso del carrello?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Scarpe antinfortunistiche e dispositivi di protezione individuale", result_answer: true },
    ...
    },
    {
      ...
      module_id: module.id,
      answer: [
        { title_answer: "Spostato il più possibile in avanti", result_answer: false },
        { title_answer: "Più vicino possibile al montante", result_answer: true },
        { title_answer: "Non ha importanza", result_answer: false },
      ],
    },
    {
      ...
      answer: [
        { title_answer: "Resta chiara", result_answer: false },
        { title_answer: "Può essere ostruita, quindi usare attenzione o retromarcia", result_answer: true },
        { title_answer: "Si può guidare normalmente", result_answer: false },
      ],
    },
    {
      question_title: "Cosa succede se si frena bruscamente con un carico pesante?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Il carico può cadere o spostarsi", result_answer: true },
        { title_answer: "Nulla, è normale", result_answer: false },
        { title_answer: "Il carrello migliora la stabilità", result_answer: false },
      ],
    },
    {
      question_title: "La zona di manovra del carrello deve essere:",
      ...
      module_id: module.id,
      answer: [
        { title_answer: "Libera da ostacoli e ben segnalata", result_answer: true },
        { title_answer: "Sempre affollata", result_answer: false },
        { title_answer: "Senza illuminazione", result_answer: false },
      ],
    },
    ...
    {
      question_title: "Il ribaltamento laterale del carrello avviene più facilmente:",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "In curva a velocità elevata", result_answer: true },
        { title_answer: "In marcia lenta su superficie piana", result_answer: false },
        { title_answer: "In retromarcia", result_answer: false },
      ],
    },
    {
      ...
      answer: [
        ...
        { title_answer: "Completamente, per garantire stabilità", result_answer: true },
    ...
    },
    {
      ...
      answer: [
        ...
        { title_answer: "No, mai", result_answer: true },
        { title_answer: "Solo con batteria quasi scarica", result_answer: false },
      ],
    },
    {
    ...
    },
    {
      ...
      answer: [
        ...
        { title_answer: "Nessun problema per i carrelli", result_answer: false },
    ...
    },
    {
      ...
      module_id: module.id,
      answer: [
        { title_answer: "Girare la testa e controllare la zona dietro", result_answer: true },
        { title_answer: "Guardare solo davanti", result_answer: false },
        { title_answer: "Usare solo gli specchi retrovisori", result_answer: false },
      ],
    },
    {
      question_title: "È permesso usare il carrello come scala per salire in alto?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
        ...
        { title_answer: "Solo se non ci sono scale disponibili", result_answer: false },
      ],
    },
    {
      ...
      answer: [
        ...
        { title_answer: "Sempre efficienti e controllati", result_answer: true },
    ...
    {
      question_title: "È possibile superare la portata massima del carrello per brevi tratti?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
    ...
    {
      question_title: "Se durante la guida l’operatore avverte vibrazioni anomale:",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
    ...
    },
    {
      ...
      module_id: module.id,
      answer: [
        { title_answer: "Sempre parallele e alla stessa altezza", result_answer: true },
        { title_answer: "Una più alta dell’altra", result_answer: false },
        { title_answer: "Non importa", result_answer: false },
      ],
    },
    {
      question_title: "Chi deve effettuare la manutenzione straordinaria del carrello?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Centri assistenza o tecnico qualificato", result_answer: true },
        { title_answer: "Operatore non formato", result_answer: false },
        { title_answer: "Chiunque", result_answer: false },
      ],
    },
    {
      question_title: "Qual è il posto più sicuro per l’operatore durante la guida?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "In piedi sui carichi", result_answer: false },
        { title_answer: "A bordo, all’interno della cabina di guida", result_answer: true },
        { title_answer: "Dietro al carrello mentre si muove", result_answer: false },
      ],
    },
    {
      question_title: "Cosa fare se si nota un odore di gas dal carrello a GPL?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Fermare immediatamente e segnalare il guasto", result_answer: true },
        { title_answer: "Accendere una sigaretta per testare", result_answer: false },
        { title_answer: "Continuare a lavorare", result_answer: false },
      ],
    },
    {
      ...
      module_id: module.id,
      answer: [
        { title_answer: "Procedere lentamente e fare attenzione agli ingombri", result_answer: true },
        { title_answer: "Mettere le forche molto in alto", result_answer: false },
        { title_answer: "Guidare velocemente per ridurre il tempo", result_answer: false },
      ],
    },
    {
      ...
      module_id: module.id,
      answer: [
        { title_answer: "L’area dove si deve parcheggiare", result_answer: false },
        { title_answer: "La zona di equilibrio che evita il ribaltamento", result_answer: true },
        { title_answer: "L’area di lavoro pericolosa per i pedoni", result_answer: false },
      ],
    },
    {
      question_title: "Quando si cambia direzione, cosa bisogna fare?",
    ...
    {
      question_title: "Quando si trasporta un carico voluminoso, cosa bisogna valutare?",
      question_level: "facile",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Stabilità e visibilità del carico", result_answer: true },
    ...
    {
      question_title: "Qual è la distanza minima da mantenere tra due carrelli in marcia?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Non ha importanza", result_answer: false },
        { title_answer: "Almeno 2 metri o secondo regolamento interno", result_answer: true },
        { title_answer: "Appena 50 cm", result_answer: false },
      ],
    },
    {
      question_title: "Come bisogna trasportare un carico lungo in corridoio?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Sempre con lato lungo parallelo al senso di marcia", result_answer: true },
        { title_answer: "Sempre perpendicolare al senso di marcia", result_answer: false },
        { title_answer: "Non importa la posizione", result_answer: false },
      ],
    },
    {
      question_title: "Prima di avviare un carrello elettrico, quale controllo è prioritario?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Livello dell’olio motore", result_answer: false },
        { title_answer: "Stato della batteria e dei cavi", result_answer: true },
        { title_answer: "Colore del carrello", result_answer: false },
      ],
    },
    {
      question_title: "Perché non usare un carrello diesel in ambienti chiusi senza ventilazione?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Perché è troppo lento", result_answer: false },
        { title_answer: "Perché i gas di scarico sono tossici e rischiano asfissia", result_answer: true },
        { title_answer: "Perché consuma troppo carburante", result_answer: false },
      ],
    },
    {
      question_title: "Quando si deposita un carico su scaffalature alte, come devono essere le forche?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Inclinate leggermente all’indietro durante il sollevamento", result_answer: true },
        { title_answer: "Inclinate in avanti sempre", result_answer: false },
        { title_answer: "Alla massima velocità", result_answer: false },
      ],
    },
    {
      question_title: "Cosa indica un segnale con triangolo giallo e simbolo carrello?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Pericolo carrelli in movimento", result_answer: true },
        { title_answer: "Parcheggio consentito solo ai carrelli", result_answer: false },
        { title_answer: "Zona vietata ai carrelli", result_answer: false },
      ],
    },
    {
      question_title: "Quando si attraversa un incrocio con scarsa visibilità, cosa fare?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Procedere lentamente e suonare il clacson", result_answer: true },
        { title_answer: "Accelerare per ridurre il tempo di attraversamento", result_answer: false },
        { title_answer: "Girare senza guardare", result_answer: false },
      ],
    },
    {
      question_title: "Durante la manutenzione del carrello, chi può operarvi sopra?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Qualsiasi operatore", result_answer: false },
        { title_answer: "Solo personale qualificato", result_answer: true },
        { title_answer: "Chiunque con istruzioni verbali", result_answer: false },
      ],
    },
    {
      question_title: "Cosa fare in caso di guasto durante la marcia?",
      ...
      answer: [
        { title_answer: "Continuare fino a fine turno", result_answer: false },
        { title_answer: "Fermarsi in sicurezza e segnalare il guasto", result_answer: true },
        { title_answer: "Spingere il carrello manualmente senza segnalarlo", result_answer: false },
      ],
    },
    {
      question_title: "Quando si deve usare la retromarcia?",
      ...
      answer: [
        { title_answer: "Sempre", result_answer: false },
        { title_answer: "Quando la visuale frontale è ostruita dal carico", result_answer: true },
        { title_answer: "Mai", result_answer: false },
      ],
    },
    {
      question_title: "Cosa fare se un carico sporge dal pallet durante il trasporto?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Trasportarlo comunque se la distanza è breve", result_answer: false },
        { title_answer: "Fissarlo o sistemarlo prima del trasporto", result_answer: true },
        { title_answer: "Alzarlo al massimo", result_answer: false },
      ],
    },
    {
      question_title: "Qual è il modo corretto di fermarsi in pendenza ripida?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Freno normale e freno di stazionamento insieme", result_answer: true },
        { title_answer: "Solo freno normale", result_answer: false },
        { title_answer: "Accelerare per bilanciare il carico", result_answer: false },
      ],
    },
    {
      question_title: "Cosa indica una luce lampeggiante arancione sul carrello?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Pericolo o segnale di attenzione", result_answer: true },
        { title_answer: "Il carrello è spento", result_answer: false },
        { title_answer: "Solo decorativa", result_answer: false },
      ],
    },
    {
      question_title: "Come comportarsi se il pavimento è scivoloso o bagnato?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Aumentare la velocità per ridurre il tempo di esposizione", result_answer: false },
        { title_answer: "Procedere lentamente e con maggiore attenzione", result_answer: true },
        { title_answer: "Non ci sono precauzioni da prendere", result_answer: false },
      ],
    },
    {
      question_title: "Quando si solleva un carico pesante, le ruote posteriori tendono a:",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Sollevarsi leggermente", result_answer: true },
        { title_answer: "Bloccarsi completamente", result_answer: false },
        { title_answer: "Diventare più stabili", result_answer: false },
      ],
    },
    {
      question_title: "Se il carrello trasporta un liquido in cisterna, quale rischio principale considerare?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Baricentro instabile con rischio ribaltamento", result_answer: true },
        { title_answer: "Riduzione della velocità di marcia", result_answer: false },
        { title_answer: "Nessun rischio particolare", result_answer: false },
      ],
    },
    {
      question_title: "Durante il trasporto di carichi multipli, come deve essere posizionato il più pesante?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "In alto e vicino alle forche", result_answer: false },
        { title_answer: "Sullo strato superiore per stabilità", result_answer: false },
        { title_answer: "Sul pallet inferiore, vicino al baricentro", result_answer: true },
      ],
    },
    {
      question_title: "Qual è la funzione del triangolo di stabilità del carrello?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Area di parcheggio riservata", result_answer: false },
        { title_answer: "Zona di equilibrio che previene il ribaltamento", result_answer: true },
        { title_answer: "Area di lavoro per i pedoni", result_answer: false },
      ],
    },
    {
      question_title: "Se le catene di sollevamento si allungano oltre il limite consentito, cosa fare?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Possono essere usate comunque se il carico è leggero", result_answer: false },
        { title_answer: "Devono essere sostituite", result_answer: true },
        { title_answer: "Accorciarle manualmente", result_answer: false },
      ],
    },
    {
      question_title: "Durante la retromarcia, come deve osservare l’ambiente l’operatore?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Solo davanti", result_answer: false },
        { title_answer: "Girare la testa e controllare dietro e ai lati", result_answer: true },
        { title_answer: "Usare solo gli specchi retrovisori", result_answer: false },
      ],
    },
    {
      question_title: "Se il carrello a GPL perde gas durante il lavoro, cosa fare?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Continuare a lavorare con cautela", result_answer: false },
        { title_answer: "Fermarsi immediatamente e segnalare il guasto", result_answer: true },
        { title_answer: "Accendere fiamme per localizzare la perdita", result_answer: false },
      ],
    },
    {
      question_title: "Quale precauzione è fondamentale quando si trasporta un serbatoio di liquido?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Procedere a velocità normale", result_answer: false },
        { title_answer: "Procedere lentamente ed evitare curve brusche", result_answer: true },
        { title_answer: "Sollevare il più possibile per avere maggiore visibilità", result_answer: false },
      ],
    },
    {
      question_title: "Qual è la posizione corretta del carico in salita su rampa?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Con il carico rivolto a monte, vicino al montante", result_answer: true },
        { title_answer: "Con il carico rivolto a valle", result_answer: false },
        { title_answer: "Non importa l’orientamento", result_answer: false },
      ],
    },
    {
      question_title: "Se si rileva perdita di olio idraulico durante il turno, cosa fare?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Continuare fino a fine turno", result_answer: false },
        { title_answer: "Fermare il mezzo e segnalare immediatamente", result_answer: true },
        { title_answer: "Pulire con un panno e ignorare", result_answer: false },
      ],
    },
    {
      question_title: "Come deve essere parcheggiato il carrello quando non è in uso?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Lasciare il motore acceso e scendere", result_answer: false },
        { title_answer: "Abbassare le forche, spegnere il motore e tirare il freno a mano", result_answer: true },
        { title_answer: "Spegnere il motore con le forche in alto", result_answer: false },
      ],
    },
    {
      question_title: "Se il carico è troppo vicino al limite di portata, cosa fare?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Sollevare comunque lentamente", result_answer: false },
        { title_answer: "Tentare più volte finché non sale", result_answer: false },
        { title_answer: "Consultare la targhetta e il responsabile prima di sollevare", result_answer: true },
      ],
    },
    {
      question_title: "Quando il carrello deve attraversare una porta stretta con carico alto, cosa fare?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Accelerare per passare velocemente", result_answer: false },
        { title_answer: "Abbassare il carico e procedere lentamente", result_answer: true },
        { title_answer: "Sollevare le forche al massimo per vedere meglio", result_answer: false },
      ],
    },
    {
      question_title: "Se durante la guida il carrello vibra o emette rumori anomali, cosa fare?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Ignorare e continuare", result_answer: false },
        { title_answer: "Fermarsi immediatamente e segnalare il guasto", result_answer: true },
        { title_answer: "Aumentare la velocità per superare il problema", result_answer: false },
      ],
    },
    {
      question_title: "Se un carico sporge lateralmente molto oltre le forche, è consentito movimentarlo?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Sì, se il percorso è breve", result_answer: false },
        { title_answer: "No, devono essere prese misure di sicurezza prima", result_answer: true },
        { title_answer: "Sì, accelerando per ridurre il rischio", result_answer: false },
      ],
    },
    {
      question_title: "Durante il sollevamento vicino a scaffalature alte, come devono essere le forche?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Inclinate leggermente all’indietro", result_answer: true },
        { title_answer: "Inclinate in avanti", result_answer: false },
        { title_answer: "Al massimo sollevamento possibile", result_answer: false },
      ],
    },
    {
      question_title: "Quando il carico supera la larghezza del corridoio, come procedere?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Forzare il passaggio rapidamente", result_answer: false },
        { title_answer: "Tenere le forche alte per passare", result_answer: false },
        { title_answer: "Usare percorsi idonei e assistenza per evitare collisioni", result_answer: true },
      ],
    },
    {
      question_title: "Durante il sollevamento di un carico instabile, cosa fare se il carrello vibra?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Continuare il sollevamento rapidamente", result_answer: false },
        { title_answer: "Sollevare le forche al massimo", result_answer: false },
        { title_answer: "Fermarsi, abbassare lentamente e stabilizzare", result_answer: true },
      ],
    },
    {
      question_title: "Durante la salita con carico voluminoso e pesante, come va orientato il carico?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Verso valle", result_answer: false },
        { title_answer: "Di lato per bilanciare", result_answer: false },
        { title_answer: "Verso monte", result_answer: true },
      ],
    },
    {
      question_title: "Durante la ricarica della batteria al piombo, cosa non bisogna mai fare?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Fumare o avvicinare fiamme", result_answer: true },
        { title_answer: "Usare area ventilata", result_answer: false },
        { title_answer: "Indossare guanti e occhiali di protezione", result_answer: false },
      ],
    },
    {
      question_title: "Quando si trasporta un carico instabile su pavimento irregolare, come comportarsi?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Ridurre la velocità e mantenere il carico basso", result_answer: true },
        { title_answer: "Accelerare per completare rapidamente il percorso", result_answer: false },
        { title_answer: "Sollevare le forche al massimo per stabilizzare", result_answer: false },
      ],
    },
    {
      question_title: "Qual è la differenza tra pneumatici pieni e pneumatici gonfiati?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Pneumatici pieni adatti a superfici lisce interne, gonfiati migliori per esterni accidentati", result_answer: true },
        { title_answer: "I pneumatici pieni sono più veloci", result_answer: false },
        { title_answer: "Nessuna differenza pratica", result_answer: false },
      ],
    },
    {
      question_title: "Cosa indica la targhetta di portata rispetto al baricentro del carico?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "La capacità massima sicura in base alla distanza del carico dal montante", result_answer: true },
        { title_answer: "Il colore delle forche", result_answer: false },
        { title_answer: "La velocità massima consentita", result_answer: false },
      ],
    },
    {
      question_title: "A cosa serve la leva di sollevamento a tre posizioni del carrello?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Sollevare, abbassare o neutralizzare le forche", result_answer: true },
        { title_answer: "Accendere e spegnere il motore", result_answer: false },
        { title_answer: "Controllare la batteria", result_answer: false },
      ],
    },
    {
      question_title: "Quale comportamento è corretto in curva stretta con carico instabile?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Accelerare per completare la curva rapidamente", result_answer: false },
        { title_answer: "Ridurre la velocità e tenere il carico basso e stabile", result_answer: true },
        { title_answer: "Sollevare le forche per migliorare la stabilità", result_answer: false },
      ],
    },
    {
      question_title: "Come deve essere pulito un carrello in modo sicuro?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Con getti d’acqua ad alta pressione", result_answer: false },
        { title_answer: "Con panno umido, carrello spento, freno a mano tirato, forche abbassate", result_answer: true },
        { title_answer: "Solo con aspirapolvere industriale", result_answer: false },
      ],
    },
    {
      question_title: "Qual è la funzione dell’indicatore multifunzione del carrello?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Controllare stato batteria, motore, potenza e segnalare guasti", result_answer: true },
        { title_answer: "Muovere le forche lateralmente", result_answer: false },
        { title_answer: "Suonare il clacson", result_answer: false },
      ],
    },
    {
      question_title: "Le ruote gemellate sul carrello servono a:",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Aumentare la capacità di carico e la stabilità", result_answer: true },
        { title_answer: "Ridurre la portata del carrello", result_answer: false },
        { title_answer: "Non hanno utilità pratica", result_answer: false },
      ],
    },
    {
      question_title: "Se un carico supera la portata del carrello, cosa succede?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Rischio ribaltamento o perdita di stabilità", result_answer: true },
        { title_answer: "Il carrello diventa automaticamente più veloce", result_answer: false },
        { title_answer: "Nulla di particolare", result_answer: false },
      ],
    },
    {
      question_title: "Durante il parcheggio su pendenza, come devono essere posizionate le forche?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Al massimo dell’altezza per sicurezza", result_answer: false },
        { title_answer: "Abbassate a terra", result_answer: true },
        { title_answer: "A metà altezza", result_answer: false },
      ],
    },
    {
      question_title: "Se le forche non sono parallele durante il sollevamento, cosa può succedere?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Carico instabile e rischio di caduta", result_answer: true },
        { title_answer: "Migliore distribuzione del peso", result_answer: false },
        { title_answer: "Nessun effetto sul carico", result_answer: false },
      ],
    },
    {
      question_title: "Cosa succede se il carrello è in pendenza senza freno inserito?",
      question_level: "intermediaire",
      question_duration: 30,
      module_id: module.id,
      answer: [
        { title_answer: "Resta fermo grazie al peso", result_answer: false },
        { title_answer: "Può scivolare o ribaltarsi", result_answer: true },
        { title_answer: "Aumenta la sua stabilità", result_answer: false },
      ],
    },
  ];
